              ...
              tabBox(width = 15, height = 2,
                     ...
                     tabPanel("Impacto general",
                              fluidRow(
                                ...
                                column(3, 
                                       radioGroupButtons('select_variable11', label = 'Seleccione la variable', choices= variables, status = "primary", selected = variables[3])
                                ),
                                
                                column(2,
                                       pickerInput('select_epoca11', label = 'Seleccione la época', choices= epoca11, selected = epoca11[1])
                                       
                                ),
                                column(2,
                                       pickerInput('select_ccaa11', label = 'Seleccione la CCAA', choices= ccaa, selected = ccaa[2])
                                       
                                ),
                                column(3, 
                                       pickerInput('select_producto11', label ='Seleccione el producto', choices= productos , selected= productos[4])
                                )
                              ),
                     ...
                     tabPanel("Temporada",
                              ...
                              fluidRow(
                                column(4, 
                                       radioGroupButtons('select_variable12', label = 'Seleccione la variable', choices= variables, status = "primary", selected = variables[3])
                                ),
                                column(2,
                                       pickerInput('select_ccaa12', label = 'Seleccione la CCAA', choices= ccaa, selected = ccaa[2])
                                       
                                ),
                                column(3, 
                                       pickerInput('select_producto12', label ='Seleccione el producto', choices= productos_en_comun , selected= productos[4])
                                ),
                                box(
                                  title = 'Impacto en las temporadas', width = 3, background = 'light-blue',
                              ...
                              fluidRow(
                                ...
                                valueBoxOutput('boxtemp', width = 4),
      ...
      tabItem(tabName = "tema2",
              tabBox(width = 15, height = 2,
                     tabPanel("Análisis general",
                              tabsetPanel(
                                tabPanel('Productos',
                                         fluidRow(
                                           column(4, 
                                                  radioGroupButtons('select_variable211', label = 'Seleccione la variable', choices= variables, status = "primary", selected = variables[3])
                                           ),
                                           column(3, 
                                                  pickerInput('select_producto211', label ='Seleccione el producto', choices= productos , selected= productos[4])
                                           ),
                                           column(5,
                                           ...
                                           box(
                                             title = "¿Dónde triunfa cada producto?", width = 3, solidHeader = TRUE,background = "light-blue",
                                         ...
                                         fluidRow(
                                           column(4, 
                                                  radioGroupButtons('select_variable212', label = 'Seleccione la variable', choices= variables, 
                                                                    status = "primary", selected = variables[2])
                                           ),
                                           column(2,
                                                  pickerInput('select_ccaa212', label = 'Seleccione la CCAA', choices= ccaa, selected = ccaa[2],
                                           ...
                                           box(
                                             title = "Comparemos los productos entre sí", width = 3, solidHeader = TRUE,background = "light-blue",
                                             "Seleccione los productos y la CCAA")
                                ...
                                tabPanel('Económico',
                                         fluidRow(
                                           column(2, 
                                                  pickerInput('select_ccaa213', label = 'Seleccione la CCAA', choices= ccaa, selected = ccaa[2])
                                           ),
                                           column(3,
                                                  pickerInput('select_producto213', label ='Seleccione el producto', choices= productos , selected= productos[4])
                                           ),
                                           column(4, h1(' ')),
                                           box(
                     ...
                     tabPanel("Top productos",
                              fluidRow(
                                column(3, 
                                       pickerInput('select_ccaa22', label = 'Seleccione CCAA', choices= ccaa_top, selected = ccaa[2])
                                ),
                                column(4,
...
server <- function(input, output) {
  ...
  output$top_productos_2020 <- renderPlot({
    ...
    table_spider_1 <- rbind(apply(X= top_2020[,-1] , MARGIN=1, FUN=max),
                            rep(0,times=input$select_topp22), top_2020[,-1])
  ...
  output$top_productos_2019 <- renderPlot({
    ...
    table_spider_2 <- rbind(apply(X= top_2019[,-1] , MARGIN=1, FUN=max),
                            rep(0,times=input$select_topp22), top_2019[,-1])
